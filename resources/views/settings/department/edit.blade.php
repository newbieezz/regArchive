...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="py-3 mb-4">Update Department / <a href="{{url('settings/department/')}}">Back</a></h4>
        ...
        <div class="col-xl">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <form action="{{url('settings/department/update/'.$department->id)}}" method="post"> @csrf
                <div class="row">
