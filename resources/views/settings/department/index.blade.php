        ...
        <div class="table-responsive text-nowrap border">
          <table class="table">
            ...
            @foreach($departments as $department)
                <tr>
                    <td><span class="fw-medium">{{ $department['id'] }} {{ $department['id'] }}</span> </td>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{url('settings/department/update/'.$department['id'])}}"><i class="fas fa-ban"></i> Update</a>
                            <a class="dropdown-item" href="{{url('settings/department/update/'.$department['id'])}}"><i class="bx bx-edit-alt me-1"></i> Delete</a>
                        </div>
                    </div>
                    </td>
                </tr>
