                  ...
                  <div class="col-sm-4 mb-2">
                    ...
                    <div class="input-group input-group-merge">
                      <select class="form-select" aria-label="enrollment_status" name="enrollment_status">
                        ...
                        <option value="{{ $key}}" {{ (old('enrollment_status', $enrollment->enrollment_status) == $key) ? 'selected' : '' }}>{{ $status}}</option>
                        @endforeach
                      </select>
                    </div>
                  ...
                  <div class="col-sm-4 mb-2">
                    ...
                    <div class="input-group input-group-merge">
                      <select class="form-select" aria-label="student_status" name="student_status">
                        ...
                        <option value="{{ $key}}" {{ (old('student_status', $enrollment->student_status) == $key) ? 'selected' : '' }}>{{ $student_status}}</option>
                        @endforeach
                      </select>
                    </div>
