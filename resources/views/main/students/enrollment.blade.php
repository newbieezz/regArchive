    ...
    <div class="card-body">
      <div class="row mb-2">
        ...
        <div class="col-6 d-flex justify-content-end">
          ...
          <a href="{{url('student/create')}}" style="color: white">
        ...
        <tr>
          ...
          <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{url('student/update/'.$student['id'])}}"><i class="bx bx-edit-alt me-1"></i> Update</a>
                    <a class="dropdown-item" href="{{url('student/destroy/')}}" ><i class="bx bx-trash me-1"></i> Delete</a>
                </div>
            </div>
          </td>
        </tr>
